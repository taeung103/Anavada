...
INSERT INTO MEMBER VALUES('admin01', 'admin01', '관리자', NULL, NULL, 'admin01@naver.com', '010-0000-0000', DEFAULT, DEFAULT);
INSERT INTO MEMBER VALUES('user01', 'user01', '이순신', NULL, NULL, 'user01@naver.com', '010-1111-1111', DEFAULT, DEFAULT);
INSERT INTO MEMBER VALUES('user02', 'user02', '권율', NULL, NULL, 'user02@naver.com', '010-2222-2222', DEFAULT, DEFAULT);
INSERT INTO MEMBER VALUES('user03', 'user03', '김시민', NULL, NULL, 'user03@naver.com', '010-3333-3333', DEFAULT, DEFAULT);
INSERT INTO MEMBER VALUES('user04', 'user04', '류성룡', NULL, NULL, 'user04@naver.com', '010-4444-4444', DEFAULT, DEFAULT);
INSERT INTO MEMBER VALUES('user05', 'user05', '김유신', NULL, NULL, 'user05@naver.com', '010-5555-5555', DEFAULT, DEFAULT);
...
INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user04', '네번째 게시글', '네번째 내용', DEFAULT, 4);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user05', '다섯번째 게시글', '다섯번째 내용', DEFAULT, 5);
...
INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user04', '아홉번째 게시글', '아홉번째 내용', DEFAULT, 9);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user05', '열번째 게시글', '열번째 내용', DEFAULT, 10);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user01', '열한번째 게시글', '열한번째 내용', DEFAULT, 11);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user02', '열두번째 게시글', '열두번째 내용', DEFAULT, 12);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user03', '열세세번째 게시글', '열세번째 내용', DEFAULT, 13);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user04', '열네번째 게시글', '열네번째 내용', DEFAULT, 14);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user05', '열다섯번째 게시글', '열다섯번째 내용', DEFAULT, 15);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user01', '열여섯번째 게시글', '열여섯번째 내용', DEFAULT, 16);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user02', '열일곱번째 게시글', '열일곱번째 내용', DEFAULT, 17);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user03', '열여덟번째 게시글', '열여덟번째 내용', DEFAULT, 18);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user04', '열아홉번째 게시글', '열아홉번째 내용', DEFAULT, 19);

INSERT INTO CBOARD(CBOARD_NO, MEMBER_ID, CBOARD_TITLE, CBOARD_CONTENT, CBOARD_DATE, LOCAL_NO) 
VALUES(CBOARD_SEQ.NEXTVAL, 'user05', '스물번째 게시글', '스물번째 내용', DEFAULT, 20);
-- sample data
...
INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 2, 'user02', DEFAULT, '두번째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 3, 'user03', DEFAULT, '세번째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 4, 'user04', DEFAULT, '네번째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 5, 'user05', DEFAULT, '다섯번째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 6, 'user01', DEFAULT, '여섯번째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 7, 'user02', DEFAULT, '일곱번째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 8, 'user03', DEFAULT, '여덟째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 9, 'user04', DEFAULT, '아홉번째 내용');

INSERT INTO CREPLY(CREPLY_NO, CBOARD_NO, MEMBER_ID, CREPLY_DATE, CREPLY_CONTENT) 
VALUES(CREPLY_SEQ.NEXTVAL, 10, 'user05', DEFAULT, '열번째 내용');
