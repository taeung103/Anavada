                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>첨부파일<%=i +1 %></td>
                            	<% if(i == 0) { %>
                                <td><%=cboard.getCfilesOriginalFilepath1()%> &nbsp; &nbsp; &nbsp; <input type="checkbox" name="delflag1" value="yes">파일삭제<input type="file" name="upfile<%=i + 1 %>" ></td>
                            	<% } else if(i == 1) { %>
                                <td><%=cboard.getCfilesOriginalFilepath2()%> &nbsp; &nbsp; &nbsp; <input type="checkbox" name="delflag2" value="yes">파일삭제<input type="file" name="upfile<%=i + 1 %>"></td>
                            	<% } else if(i == 2) { %>
                                <td><%=cboard.getCfilesOriginalFilepath3()%> &nbsp; &nbsp; &nbsp; <input type="checkbox" name="delflag3" value="yes">파일삭제<input type="file" name="upfile<%=i + 1 %>"></td>
                            	<% } else if(i == 3) { %>
                                <td><%=cboard.getCfilesOriginalFilepath4()%> &nbsp; &nbsp; &nbsp; <input type="checkbox" name="delflag4" value="yes">파일삭제<input type="file" name="upfile<%=i + 1 %>"></td>
                            	<% } %>
                            </tr>
                            <% } %>
                        </tbody>
