    ...
    <div id="admin_container">
        ...
        <div class="admin_content" style="width: 1400px;">
            ...
            <form action="/anavada/binsert.ad"  method="post" enctype="multipart/form-data" class="form-inline" onesubmit="return validate();">
                <fieldset>
                    <div class="faqTap">
                    <a href="/anavada/fbinsert.ad">[축제 불러오기]</a>
                    <a href="/anavada/fbupdate.ad">[축제 업데이트]</a>
                    <a href="/anavada/fbdelete.ad">[지난 축제 삭제하기]</a>
                    <a href="/anavada/fbdeleteall.ad">[전체 축제 삭제하기]</a>
                    </div>
                    <script type="text/javascript">
