        ...
        <div id="content">
                ...
                <div class="vsv-copy sub-title">
                   <div>
                        <ul class="navi">
                            ...
                            <li class="glyphicon glyphicon-menu-right"><a href="#none">커뮤니티조회</a></li>
                        </ul>
                    </div>
            ...
            <div class="MyTap">
                <ul>
                    ...
                    <li class="active"><a href="MyCmnt.jsp">커뮤니티조회</a></li>
            ...
            <div class="mypage_area list-area">
               ...
               <!--종류 리스트-->
                <div class="sort-area">  
                    <h4>전체 150개</h4>
                    <a href="../cboard/community_write.jsp" class="write_btn">글쓰기</a>
                    <div>
                ...
                <table class="cmnt_list">
                    <tbody>
                        <tr onclick="location.href='../community/community_view.jsp';">
                ...
                <div class="write-btn">
                    <a href="../cboard/community_write.jsp">글쓰기</a>
                </div>
