<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@page import="member.emailChk.Gmail"%>
<%@page import="member.emailChk.SHA256"%>
...
<%
	String host = "http://localhost:8900/anavada/";
	String from = "spark1033";
	String to = request.getParameter("memberEmail");
	...
	p.put("mail.smtp.gcontroll", from);
