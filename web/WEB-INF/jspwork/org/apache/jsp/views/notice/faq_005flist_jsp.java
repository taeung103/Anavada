 ...
 * Generated at: 2020-08-13 00:28:35 UTC
...
public final class faq_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/notice/../include/header.jsp", Long.valueOf(1597277304995L));
    _jspx_dependants.put("/views/notice/../include/head.jsp", Long.valueOf(1597277304995L));
    _jspx_dependants.put("/views/notice/../include/footer.jsp", Long.valueOf(1597277304994L));
  }
 ...
 Member member = (Member)request.getAttribute("member"); 
      ...
      out.write("    </script>\r\n");
      out.write("    <script>\r\n");
      out.write("//    input[id*=\"answer\"]:checked + label + div { max-height:100px; }\r\n");
      out.write("    /* function (){\r\n");
      out.write("    \t\r\n");
      out.write("    } */\r\n");
      out.write("    $(function(){\r\n");
      out.write("    \t$(\".question#answer\").click(function(){\r\n");
      out.write("    \t\tvar qua = $(this).val();\r\n");
      out.write("    \t\tconsole.log(qua);\r\n");
      out.write("    \t});\r\n");
      out.write("    });\r\n");
      out.write("    </script>\r\n");
      out.write("    <!-- <script type=\"text/javascript\">\r\n");
      ...
      out.write("    \t\t\t\t\t\tvalues += \"<li class='Qmarker'><span>Q</span></li>\";\r\n");
      out.write("    \t\t\t\t\t\tvalues += \"<li class='title'>\";\r\n");
      out.write("    \t\t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t\tswitch(category) {\r\n");
      out.write("    \t\t\t\t\t\t//<span class='Msel'>회원정보</span>\r\n");
      out.write("    \t\t\t\t\t\tcase \"회원정보\" : values += \"<span class='Msel'>회원정보</span>\"; break;\r\n");
      out.write("        \t\t\t\t\tcase \"중고거래\" : values += \"<span class='Psel'>중고거래</span>\"; break;\r\n");
      out.write("        \t\t\t\t\tcase \"커뮤니티\" : values += \"<span class='Csel'>커뮤니티</span>\"; break;\r\n");
      out.write("        \t\t\t\t\tcase \"지역축제\" : values += \"<span class='Esel'>지역축제</span>\"; break;\r\n");
      out.write("        \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t\tvalues += decodeURIComponent(json.list[i].title).replace(/\\+/gi, \" \") +\"</li>\";\r\n");
      out.write("    \t\t\t\t\t\tvalues += \"<li>관리자</li>\";\r\n");
      out.write("    \t\t\t\t\t\tvalues += \"<li>\"+ json.list[i].date +\"</li></ul>\";\r\n");
      out.write("    \t\t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t\tvalues += \"<ul class='ctn'>\";\r\n");
      out.write("    \t\t\t\t\t\tvalues += \"<li class='Amarker'><span>A</span></li>\";\r\n");
      out.write("    \t\t\t\t\t\tvalues += \"<li><h4>답변</h4><p>\"+ decodeURIComponent(json.list[i].content).replace(/\\+/gi, \" \") +\"</p></li></ul>\";\r\n");
      out.write("    \t\t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t\tswitch(category) {\r\n");
      out.write("    \t\t\t\t\tcase \"회원정보\" : $(\".qna_list#tab02\").html(values); break;\r\n");
      out.write("    \t\t\t\t\tcase \"중고거래\" : $(\".qna_list#tab03\").html(values); break;\r\n");
      out.write("    \t\t\t\t\tcase \"커뮤니티\" : $(\".qna_list#tab04\").html(values); break;\r\n");
      out.write("    \t\t\t\t\tcase \"지역축제\" : $(\".qna_list#tab05\").html(values); break;\r\n");
      out.write("    \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t\t\r\n");
      out.write("    \t\t\t\t},\r\n");
 ...
 if(loginMember == null){ 
      ...
      out.write("                <div class=\"faqTap\">\r\n");
      out.write("                    <a href=\"/anavada/flist\" class=\"active\" data-tab=\"tab01\">전체</a>\r\n");
      out.write("                    <a href=\"/anavada/fselect?cate=1\" data-tab=\"tab02\">회원정보</a>\r\n");
      out.write("                    <a href=\"/anavada/fselect?cate=2\" data-tab=\"tab03\">중고거래</a>\r\n");
      out.write("                    <a href=\"/anavada/fselect?cate=3\" data-tab=\"tab04\">커뮤니티</a>\r\n");
      out.write("                    <a href=\"/anavada/fselect?cate=4\" data-tab=\"tab05\">지역축제</a>\r\n");
      out.write("                </div>\r\n");
      out.write("                <!--종류 리스트-->\r\n");
...
break;
                        	   case 2 : 
      out.write("<span class=\"Psel\">중고거래</span>");
break;
                        	   case 3 : 
      out.write("<span class=\"Csel\">커뮤니티</span>");
break;
                        	   case 4 : 
      out.write("<span class=\"Esel\">지역축제</span>");
break;
                        	 } 
      out.write("\r\n");
      out.write("                        \t\r\n");
