 ...
 * Generated at: 2020-08-12 08:15:08 UTC
...
public final class faq_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/notice/../include/header.jsp", Long.valueOf(1597211168291L));
    _jspx_dependants.put("/views/notice/../include/head.jsp", Long.valueOf(1597190184254L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ArrayList<Faq> list = (ArrayList<Faq>)request.getAttribute("list");
      ...
      out.write("    input[type=\"radio\"] + label { display:inline-block;padding:20px;background:#ccc;color:#999;font-size:14px;cursor:pointer; }\r\n");
      out.write("    input[name=\"tabmenu\"]:checked + label { background:#aaa;color:#000; }\r\n");
      out.write("    \r\n");
      out.write("    .conbox { width:500px;margin:0 auto;display:none; }\r\n");
      out.write("\tinput[id=\"tab01\"]:checked ~ .con1 { display:block; }\r\n");
      out.write("\tinput[id=\"tab02\"]:checked ~ .con2 { display:block; }\r\n");
      out.write("\tinput[id=\"tab03\"]:checked ~ .con3 { display:block; }\r\n");
      out.write("\tinput[id=\"tab04\"]:checked ~ .con4 { display:block; }\r\n");
      out.write("\tinput[id=\"tab05\"]:checked ~ .con5 { display:block; }\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t/* input[id*=\"answer\"] { display:none; } */\r\n");
      out.write("\tinput[id*=\"answer\"] + label {\r\n");
      out.write("\t\tdisplay:block;\r\n");
      out.write("\t \tpadding:20px;\r\n");
      out.write("\t\tborder:1px solid #232188;\r\n");
      out.write("\t\tborder-bottom:0;\r\n");
      out.write("\t\tcolor:#fff;\r\n");
      out.write("\t\tfont-weight:900;\r\n");
      out.write("\t\tbackground:#3634a5;\r\n");
      ...
      out.write("\t\tbackground:#ebf8ff;\r\n");
      out.write("\t\tfont-size:11px; \r\n");
      out.write("\t} \r\n");
      out.write("\t input[id*=\"answer\"] + label + div p {\r\n");
      ...
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("    $(function(){\r\n");
      out.write("    \t$(\"input[name=tabmenu]\").each(function(index){\r\n");
      ...
      out.write("    \t\t\t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t\tvalues += \"<input type='radio' name='accordion' id='answer\"+ json.list[i].no +\"'><label for='answer\"\r\n");
      out.write("    \t\t\t\t\t\t\t\t+ json.list[i].no +\"'>\"+ decodeURIComponent(json.list[i].title).replace(/\\+/gi, \" \")\r\n");
      out.write("    \t\t\t\t\t\t\t\t+\"</label><div><p>\"+ decodeURIComponent(json.list[i].content).replace(/\\+/gi, \" \") +\"</p></div>\";\r\n");
      out.write("                \t\t\t\r\n");
      out.write("    \t\t\t\t\t} //for in\r\n");
      out.write("    \t\t\t\t\tswitch(category){\r\n");
      out.write("    \t\t\t\t\tcase \"회원정보\" : $(\"#t02\").html(values); break;\r\n");
      out.write("    \t\t\t\t\tcase \"중고거래\" : $(\"#t03\").html(values); break;\r\n");
      out.write("    \t\t\t\t\tcase \"커뮤니티\" : $(\"#t04\").html(values); break;\r\n");
      out.write("    \t\t\t\t\tcase \"지역축제\" : $(\"#t05\").html(values); break;\r\n");
      out.write("    \t\t\t\t\t}\r\n");
      out.write("    \t\t\t\t},\r\n");
 ...
 if(loginMember == null){ 
      ...
      out.write("            <br><br><br>\r\n");
      out.write("            <div class=\"tab_content\" align=\"center\">\r\n");
      out.write("            \t<input type=\"radio\" name=\"tabmenu\" id=\"tab01\" checked> <!-- value=\"전체\"> -->\r\n");
      out.write("            \t<label for=\"tab01\">전체</label>\r\n");
      out.write("            \t<input type=\"radio\" name=\"tabmenu\" id=\"tab02\" value=\"회원정보\">\r\n");
      out.write("            \t<label for=\"tab02\">회원정보</label>\r\n");
      out.write("            \t<input type=\"radio\" name=\"tabmenu\" id=\"tab03\" value=\"중고거래\">\r\n");
      out.write("            \t<label for=\"tab03\">중고거래</label>\r\n");
      out.write("            \t<input type=\"radio\" name=\"tabmenu\" id=\"tab04\" value=\"커뮤니티\">\r\n");
      out.write("            \t<label for=\"tab04\">커뮤니티</label>\r\n");
      out.write("            \t<input type=\"radio\" name=\"tabmenu\" id=\"tab05\" value=\"지역축제\">\r\n");
      out.write("            \t<label for=\"tab05\">지역축제</label>\r\n");
      out.write("            \t<br><br><br>\r\n");
      out.write("            \t\r\n");
      out.write("            \t<div class=\"conbox con1\" id=\"t01\">\r\n");
      out.write("            \t \t<div class=\"open\" id=\"open\">\r\n");
      out.write("            \t\t");
 for(Faq f : list) { 
      out.write("\r\n");
      out.write("            \t\t\t<input type=\"radio\" name=\"accordion\" id=\"Fanswer");
      out.print( f.getFaqNo() );
      out.write("\">\r\n");
      out.write("            \t\t\t<label for=\"Fanswer");
      out.print( f.getFaqNo() );
      out.write('"');
      out.write('>');
      ...
      out.write("</div>\r\n");
      out.write("            \t</div>\r\n");
      out.write("            \t<div class=\"conbox con2\" id=\"t02\"></div>\r\n");
      out.write("            \t<div class=\"conbox con3\" id=\"t03\"></div>\r\n");
      out.write("            \t<div class=\"conbox con4\" id=\"t04\"></div>\r\n");
      out.write("            \t<div class=\"conbox con5\" id=\"t05\"></div>\r\n");
      out.write("            \t\r\n");
      out.write("            \t\r\n");
