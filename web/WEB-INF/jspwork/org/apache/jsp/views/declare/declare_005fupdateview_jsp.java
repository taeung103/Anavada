 ...
 * Generated at: 2020-08-10 06:40:49 UTC
...
public final class declare_005fupdateview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/declare/../include/header.jsp", Long.valueOf(1597018699839L));
 ...
 if(loginMember == null){ 
      ...
      out.write("\t\t\t\t<form action=\"/anavada/dboupdate.ad\" method=\"post\"\r\n");
      out.write("\t\t\t\t\tonesubmit=\"return validate();\" >\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"no\" value=");
      out.print( dbo.getDboNo() );
      out.write(">\r\n");
      out.write("\t\t\t\t\t<h3 class=\"declare_btn2\">\r\n");
      out.write("\t\t\t\t\t\t<span> <i class=\"glyphicon glyphicon-bell\"></i>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
if(dbo.getDboChe() != null ){
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"che\" value=\"Y\" >처리완료 \r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"che\" value=\"N\" >처리미완료\r\n");
      out.write("\t\t\t\t\t\t\t\t");
 }else{ 
      out.write("&nbsp; ");
 } 
      ...
      out.write("\t\t\t\t\t</h3>\r\n");
      out.write("\t\t\t\t\t<h2>\r\n");
      out.write("\t\t\t\t\t\t<span class=\"declare\">신고</span>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( dbo.getDboTitle() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</h2>\r\n");
      out.write("\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t    <li><span>글번호 : </span>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print( dbo.getDboNo() );
      out.write("</td>\r\n");
      ...
      out.write("</td></li>\r\n");
      out.write("\t\t\t\t\t\t<li><span>첨부파일 : </span>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
 if( dbo.getDboOriginal() != null ){ 
      out.write(" <a\r\n");
      out.write("\t\t\t\t\t\t\t\thref=\"/anavada/dbofdown?ofile=");
