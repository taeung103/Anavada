 ...
 * Generated at: 2020-08-14 05:08:36 UTC
...
public final class MyDeclare_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/member/../include/head.jsp", Long.valueOf(1597277304995L));
    _jspx_dependants.put("/views/member/../include/footer.jsp", Long.valueOf(1597277304994L));
    _jspx_dependants.put("/views/member/../include/header.jsp", Long.valueOf(1597375998632L));
  }
 ...
 if(loginMember == null){ 
      ...
      out.write("                            <li class=\"glyphicon glyphicon-menu-right\"><a href=\"#none\">신고하기조회</a></li>\r\n");
      out.write("                        </ul>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("                <ul>\r\n");
      out.write("                    <li><a href=\"mypage.ss\">정보수정</a></li>\r\n");
      ...
      out.write("                    <li class=\"active\"><a href=\"/anavada/dbomylist.ss\">신고하기조회</a></li>\r\n");
      out.write("                </ul>\r\n");
      out.write("            </div>\r\n");
      out.write("            <!--서브 카테고리 끝-->\r\n");
      out.write("\r\n");
      out.write("            \r\n");
      out.write("            <!-- 리스트 -->\r\n");
      out.write("            <div class=\"mypage_area list-area\">\r\n");
      out.write("                <h2 class=\"mypage_title\">나의 신고내역</h2>\r\n");
      out.write("               <!--종류 리스트-->\r\n");
      out.write("                <div class=\"sort-area\">  \r\n");
      out.write("                    <h4>전체 ");
      out.print( totalList );
      out.write(" 개</h4>\r\n");
      out.write("                    <!-- <a href=\"../declare/declare_write.jsp\" class=\"write_btn\">글쓰기</a> -->\r\n");
      out.write("                    <div>\r\n");
 ...
 if(totalList == 0 ) { 
      ...
      out.write("\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t  <img src=\"/anavada/resources/images/btnIcn/icn_big_listNo.png\" alt=\"\" title=\"\" />\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t<h1>작성한 글이 없습니다.</h1>\r\n");
      out.write("\t\t       </div>\r\n");
      out.write("\t\t  ");
 }else { 
      out.write("\r\n");
...
for(DBo d : list) { System.out.println(d);
      out.write("\r\n");
      out.write("                        <tr id=\"click\" onclick=\"location.href='/anavada/dbodetail?dboNo=");
      ...
      out.write("                                <h2><span class=\"declare\">신고</span>");
      ...
      out.write("</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>작성일 : ");
      out.print( d.getDboDate() );
      out.write("</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>조회수 : 30 <!-- 나중에 --></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<li>유형 : ");
      out.print( d.getDboType() );
      out.write("</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("                            <td class=\"declare_btn\">\r\n");
      out.write("                            \t\t");
 if(d.getDboChe().equals("Y")){ 
      out.write("\r\n");
      out.write("                    \t\t\t\t<span><i class=\"glyphicon glyphicon-bell\"></i>처리완료</span>\r\n");
      out.write("                    \t\t\t\t");
 }else{// 처리완료된건
      out.write("\r\n");
      out.write("            \t\t    \t\t\t<span><i class=\"glyphicon glyphicon-bell\"></i>처리중</span>\r\n");
      out.write("            \t\t    \t\t\t");
 }  
      out.write("\r\n");
      out.write("            \t\t    \t</td> \r\n");
      ...
      out.write("                    <a href=\"/anavada/views/declare/declare_write.jsp\">글쓰기</a>\r\n");
      out.write("                </div>\r\n");
      out.write("                </form>\r\n");
      out.write("\r\n");
      out.write("            </div>\r\n");
 ...
 if(currentPage <= 1){ 
      ...
      out.write("\r\n");
      out.write("                \t<a href=\"/anavada/dbomylist.ss?page=1\"><i class=\"glyphicon glyphicon-menu-left\"></i></a>\r\n");
      out.write("                ");
 } 
      out.write("\r\n");
      out.write("                <!-- 이전으로 이동처리 -->\r\n");
 ...
 for(int p = startPage; p <= endPage; p++){ 
      ...
      out.write("\r\n");
      out.write("                \t\t<a href=\"/anavada/dbomylist.ss?page=");
      out.print( p );
      out.write('"');
      out.write('>');
      out.print( p );
