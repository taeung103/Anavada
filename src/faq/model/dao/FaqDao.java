...
///////////////////////////////////////////////////////////////////
	...
	public int getListCount(Connection conn, String column ,String keyword) {
		...
		else query += "where faq_content like ?";
	...
	public ArrayList<Faq> searchTorC(Connection conn, int currentPage, int limit, String keyword, String column) {
		ArrayList<Faq> list = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		else query += "where faq_content like ?) where rnum >= ? and rnum <= ?";
