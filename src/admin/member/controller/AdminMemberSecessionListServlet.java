 ...
 */
@WebServlet("/leavelist.ad")
public class MemberSecessionListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberSecessionListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Member> list = new MemberService().selectLeaveList(currentPage, limit, search, keyword);
