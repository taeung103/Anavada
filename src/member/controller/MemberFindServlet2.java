...
public class MemberFindServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(member == null || !member.getMemberPhone().equals(memberEmail)) {
			...
			try {
				...
				msg.setText("안녕하세요. Anavada 입니다.<br/>"
							+ "회원님의 임시 비밀번호는 : " + temp + "입니다.<br/>"
							+ "임시비밀번호로 로그인 후 마이페이지에서<br/>"
							+ "꼭 비밀번호를 변경하시기 바랍니다.");

				Transport.send(msg);
				System.out.println("임시비밀번호 이메일 전송 완료.");
	         ...
	         request.getRequestDispatcher("/views/login_myPage/searchPasswordEnd.jsp");
