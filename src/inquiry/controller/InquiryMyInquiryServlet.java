...
/**
 * Servlet implementation class InquiryMyInquiryServlet
 */
@WebServlet("/miq")
public class InquiryMyInquiryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InquiryMyInquiryServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list.size() > -1) {
			RequestDispatcher view = request.getRequestDispatcher("views/member/MyInquiry.jsp");
