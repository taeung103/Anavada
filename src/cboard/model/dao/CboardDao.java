...
public class CboardDao {
	...
	public ArrayList<Cboard> selectLocal(Connection conn, int currentPage, int limit, String local) {
		ArrayList<Cboard> list = new ArrayList<Cboard>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		String query = "select * "
				...
				+ "cfiles_original_filepath3, cfiles_rename_filepath3, "
				+ "cfiles_original_filepath4, cfiles_rename_filepath4 "
				+ "from (select * from cboard where local_no = ? order by cboard_no desc)) "
				+ "where rnum >= ? and rnum <= ?";
	...
	public int getLocalListCount(Connection conn, String local) {
		int listCount = 0;
		
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		
		String query = "select count(*) from cboard where local_no = ?";
